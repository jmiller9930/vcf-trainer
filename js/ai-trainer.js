/* ==========================================================================
   ...
   Roles (locked):
     DeepSeek  → AI Trainer coach + optional spoken lesson SCRIPT (text only)
     OpenAI    → ONE Listen pipeline (TTS voice only — Southern / Texas)
     No device-voice fallback on Listen (avoids overlap)
